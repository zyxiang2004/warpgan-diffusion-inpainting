#!/bin/bash
# =============================================================================
# v19 W6-A (GPU 0): W3-P recipe + anchor_median=5 + real LPIPS + adv×1.0
# The "strengthened W3-P" — gpt.md's ablation step 5 (local adversarial) at
# a MEANINGFUL weight (orig WarpGAN used ×10; InvSR used ×0.1 as the smallest
# term because they had strong LPIPS; we increase 10x from InvSR's value).
# From scratch → 300K (matching original WarpGAN's training duration).
# NO SDEdit, NO prompt, NO HF, NO prior_preserve — only proven components.
# =============================================================================
ARM=w6a
GPU=${GPU:-0}
