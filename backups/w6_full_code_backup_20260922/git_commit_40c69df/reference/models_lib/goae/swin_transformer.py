...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        # Use a scalar bound. Constructing torch.tensor(100) here creates a CPU
        # tensor and breaks CUDA inference when self.logit_scale is on the GPU.
...
class SwinTransformer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        return x, x_query, x_coarse, x_mid, x_fine
