...
class IDLoss(nn.Module):
    def __init__(self):
        ...
        self.face_pool1 = torch.nn.AdaptiveAvgPool2d((256, 256))
        self.face_pool2 = torch.nn.AdaptiveAvgPool2d((112, 112))
        self.facenet.eval()
        for module in [self.facenet, self.face_pool1, self.face_pool2]:
