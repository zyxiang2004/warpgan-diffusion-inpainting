...
from models.saicinpainting.training.modules.ffc import FFCResNetGenerator
from models.saicinpainting.training.modules.ffc_style import FFCStyleResNetGenerator
from models.saicinpainting.training.modules.pix2pixhd import GlobalGenerator, MultiDilatedGlobalGenerator, \
...
def make_generator(config, kind, **kwargs):
    ...
    if kind == 'ffc_style_resnet':
        return FFCStyleResNetGenerator(**kwargs)
