...
from models.saicinpainting.training.modules.base import get_activation, BaseDiscriminator
...
from models.saicinpainting.utils import get_shape
...
class FFCResNetGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64, n_downsampling=3, n_blocks=9, norm_layer=nn.BatchNorm2d,
        ...
        input_nc = input_nc + 3 if cat_3dgan else input_nc
