...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # c_novel = torch.from_numpy(c_novel)
        c_novel = []
        ...
        # return image_resized, image, torch.from_numpy(label), mirror_image_resized, mirror_image, torch.from_numpy(mirror_label), mirror_conf_map, depth, fname
        return image_resized, image, torch.from_numpy(label), c_novel, fname
