...
class StableDiffusion3InvEnhancePipeline(DiffusionPipeline):
    r"""
    Args:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # 4. Prepare timesteps
        num_inference_steps = retrieve_timesteps(self.scheduler, device, timesteps)
