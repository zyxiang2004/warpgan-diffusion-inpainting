#!/bin/bash
# =============================================================================
# v18-wave1 FULL arm (GPU 2): distribution supervision at ORIG density.
# FM x100 + adv x10 (orig weights), whole family ab_t-SNR-weighted (v18),
# native-resolution patch decode, view-aligned pixel-paired D pairs (P1 fix),
# per-batch-type D health logging. Everything else = CTRL base.
# =============================================================================
ARM=full
GPU=${GPU:-2}
