...
try:
    ...
    _import_structure["pipeline_stable_diffusion_3_inversion_sr"] = ["StableDiffusion3InvEnhancePipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_3_inversion_sr import StableDiffusion3InvEnhancePipeline
