...
from editings.CLIPStyle.mapper import latent_mappers
...
class StyleCLIPMapper(nn.Module):
	...
	def __init__(self, opts, G=None, load_G=True):
	...
	def load_weights(self, load_decoder=True):
	...
	def forward(self, x, c, resize=True, latent_mask=None, input_code=False, randomize_noise=True,
		...
		images = self.G.synthesis(codes, c)['images']
		result_latent = codes
